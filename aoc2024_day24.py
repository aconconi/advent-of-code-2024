...
if __name__ == "__main__":
    ...
    print("Day 24 Part 1:")
    print(day24_part1(input_data))  # Correct answer is 48063513640678

    print("Day 24 Part 2:")
    print(
        day24_part2(input_data)
    )  # Correct answer is "hqh,mmk,pvb,qdq,vkq,z11,z24,z38"
